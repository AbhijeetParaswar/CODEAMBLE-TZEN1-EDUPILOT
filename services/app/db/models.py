...
class StudentProfile(Base):
    ...
    # Extra Scholarship Profile fields
    domicile_state: Mapped[str | None] = mapped_column(String(64), nullable=True)
    academic_level: Mapped[str | None] = mapped_column(String(64), nullable=True)
    institution_type: Mapped[str | None] = mapped_column(String(64), nullable=True)
    percentage_10th: Mapped[float | None] = mapped_column(Float, nullable=True)
    previous_year_marks_percentage: Mapped[float | None] = mapped_column(Float, nullable=True)
    is_single_girl_child: Mapped[bool | None] = mapped_column(Boolean, default=False, nullable=True)
    is_orphan: Mapped[bool | None] = mapped_column(Boolean, default=False, nullable=True)
    is_pwd: Mapped[bool | None] = mapped_column(Boolean, default=False, nullable=True)
    pwd_percentage: Mapped[float | None] = mapped_column(Float, nullable=True)
    is_ward_of_defense_personnel: Mapped[bool | None] = mapped_column(Boolean, default=False, nullable=True)
    bank_account_seeded_aadhaar: Mapped[bool | None] = mapped_column(Boolean, default=False, nullable=True)
