...
class StudentProfileCreate(BaseModel):
    ...
    # Scholarship profile fields
    domicile_state: str | None = None
    academic_level: str | None = None
    institution_type: str | None = None
    percentage_10th: float | None = None
    previous_year_marks_percentage: float | None = None
    is_single_girl_child: bool | None = None
    is_orphan: bool | None = None
    is_pwd: bool | None = None
    pwd_percentage: float | None = None
    is_ward_of_defense_personnel: bool | None = None
    bank_account_seeded_aadhaar: bool | None = None
