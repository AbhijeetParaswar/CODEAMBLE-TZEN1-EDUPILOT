          ...
          <div className="flex flex-col items-center justify-center h-full text-center transition-colors duration-500">
            ...
            <div className="flex flex-wrap gap-2 justify-center">
              {[
                ...
                {
                  label: "Eligibility Help",
                  q: "Explain the eligibility criteria for merit scholarships",
                },
              ].map(({ label, q }) => (
                <button
                  key={label}
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex items-end gap-2 transition-colors duration-500">
            ...
            <button
              onClick={sendMessage}
              disabled={
                (!input.trim() && !selectedFile) || isLoading || !session?.user
              }
...
function MessageBubble({ message, onCopy }: MessageBubbleProps) {
  ...
  return (
    ...
    >
      ...
      <div
        className={`flex flex-col gap-1 max-w-[75%] ${isUser ? "items-end" : "items-start"} transition-colors duration-500`}
      >
