...
export default function DashboardHeader({ userName }: Props) {
  ...
  return (
    <header className="h-22.5 sticky top-0 z-40 bg-white/90 dark:bg-[#08090E]/90 backdrop-blur-md border-b border-black/10 dark:border-white/8 px-6 py-5 flex items-center justify-between gap-4 transition-all duration-500">
      <div>
        ...
        <p className="font-mono text-sm text-gray-400 dark:text-[#6B7280]">
